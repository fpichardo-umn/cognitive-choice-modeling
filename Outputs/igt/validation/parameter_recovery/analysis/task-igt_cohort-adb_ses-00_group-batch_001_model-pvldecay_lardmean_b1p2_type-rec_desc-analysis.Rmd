---
title: "Parameter Recovery Analysis: igt - pvldecay_lardmean_b1p2 - batch_001"
output: 
  html_document:
    toc: true
    toc_float: true
...
recovery_file <- "/Users/icd/Library/CloudStorage/Dropbox/Projects/modeling_mIGT/Data/igt/sim/recovery/task-igt_cohort-adb_ses-00_group-batch_001_model-pvldecay_lardmean_b1p2_type-rec_desc-data.csv"
...
This document presents parameter recovery analysis for the **pvldecay_lardmean_b1p2** model (RL type) applied to the **igt** task with group type **batch_001**.
...
This analysis examines parameter recovery performance for the pvldecay_lardmean_b1p2 model. Key metrics include correlation between true and recovered parameters, RMSE (root mean square error), bias, and relative bias.
