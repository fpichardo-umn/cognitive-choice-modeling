---
title: "Model Comparison Analysis: igt"
output: 
  html_document:
    toc: true
    toc_float: true
...
# Data for comparison
models <- c('ev', 'pvldelta', 'pvldecay', 'pvlboth', 'nnldelta', 'nnldecay', 'nnlboth', 'vpp', 'orl', 'vse')
task <- "igt"
group <- "batch_001"
recovery_data <- read.csv("task-igt_cohort-luc_ses-00_group-batch_001_model-all_type-rec_desc-data.csv")
...
## Model Comparison Overview: igt

This document presents a comprehensive comparison of different computational models applied to the **igt** task with group type **batch_001**. The comparison uses parameter recovery analysis and various information criteria to evaluate model performance.
