// Hierarchical VPP-Decay-ARD Model for the Iowa Gambling Task
functions {
  ...
  // Combined VPP-Decay-ARD model function with trial-varying parameters
...
model {
  ...
  for (n in 1:N) {
    ...
    target += igt_vppdecay_ard_model_lp(
        choice[n, 1:Tsubj[n]], wins[n, 1:Tsubj[n]], losses[n, 1:Tsubj[n]], RT[n, 1:Tsubj[n]],
        ev, pers, Tsubj[n],
        gain[n], loss[n], decay[n], epP[n], epN[n], K[n], w[n],
