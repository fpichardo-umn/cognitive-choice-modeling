functions {
  array[] vector igt_model_lp(
      ...
      real gain, real loss, real retend, real k, real w, real ep
      ) {
    // Define values
    ...
    for (t in 1:Tsub) {
      ...
      local_ev = local_ev * retend;
      
      // Update chosen deck by adding utility
...
parameters {
  ...
  real retend_pr;  // Retention/decay parameter
