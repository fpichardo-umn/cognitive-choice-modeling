// Hierarchical PVL-Decay-ARD Model for the Iowa Gambling Task
functions {
  ...
  // Combined PVL-Decay-ARD model function with trial-varying parameters
  real igt_pvldecay_ard_model_lp(
...
model {
  ...
  for (n in 1:N) {
    ...
    target += igt_pvldecay_ard_model_lp(
