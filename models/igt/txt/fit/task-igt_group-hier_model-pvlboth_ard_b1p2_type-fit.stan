// Hierarchical PVL-Both-ARD Model for the Iowa Gambling Task
functions {
  ...
  // Combined PVL-Both-ARD model function with trial-varying parameters
  real igt_pvlboth_ard_model_lp(
    ...
    for (t in 1:T) {
      ...
      // Compute all 12 drift rates for this trial using PVL-learned values
