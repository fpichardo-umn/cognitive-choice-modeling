...
parameters {
  // NCP Hyperparameters (Index 1: update)
  real mu_pr_update;
  ...
  vector[N] update_pr;                   // Non-Centered
...
transformed parameters {
  ...
  // Apply Non-Centered reparameterization for Update only
...
generated quantities {
  // mu_con, mu_gain, mu_loss are already in parameters
