functions {
  vector igt_model_lp(
      ...
      real retend, real k, real w, real ep
      ) {
    // Define values
...
parameters {
  ...
  real<lower=-3, upper=3> retend_pr;      // Retention rate (replaces decay)
...
transformed parameters {
  ...
  real<lower=0, upper=1> retend;          // Retention rate (equivalent to 1-decay)
