---
title: "Parameter Recovery Analysis: igt_mod - pvlboth_ddm - batch_001"
output: 
  html_document:
    toc: true
    toc_float: true
...
recovery_file <- "/users/7/fpichard/Projects/modeling_mIGT/Data/sim/recovery/recovery_igt_mod_pvlboth_ddm_batch_001.csv"
...
This document presents parameter recovery analysis for the **pvlboth_ddm** model (RL_SSM type) applied to the **igt_mod** task with group type **batch_001**.
...
This analysis examines parameter recovery performance for the pvlboth_ddm model. Key metrics include correlation between true and recovered parameters, RMSE (root mean square error), bias, and relative bias.
