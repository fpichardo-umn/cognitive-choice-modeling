---
title: "Parameter Recovery Analysis: igt_mod - dualp_bbu - batch_001"
output: 
  html_document:
    toc: true
    toc_float: true
...
recovery_file <- "/Users/icd/Library/CloudStorage/Dropbox/Projects/modeling_mIGT/Data/igt_mod/sim/recovery/recovery_igt_mod_dualp_bbu_batch_001.csv"
...
This document presents parameter recovery analysis for the **dualp_bbu** model (RL type) applied to the **igt_mod** task with group type **batch_001**.
...
This analysis examines parameter recovery performance for the dualp_bbu model. Key metrics include correlation between true and recovered parameters, RMSE (root mean square error), bias, and relative bias.
