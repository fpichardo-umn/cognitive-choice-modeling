---
title: "Parameter Recovery Analysis: igt_mod - pulboth - batch_001"
output: 
  html_document:
    toc: true
    toc_float: true
...
recovery_file <- "/Users/icd/Library/CloudStorage/Dropbox/Projects/modeling_mIGT/Data/sim/recovery/recovery_igt_mod_pulboth_batch_001.csv"
...
This document presents parameter recovery analysis for the **pulboth** model (RL type) applied to the **igt_mod** task with group type **batch_001**.
...
This analysis examines parameter recovery performance for the pulboth model. Key metrics include correlation between true and recovered parameters, RMSE (root mean square error), bias, and relative bias.
