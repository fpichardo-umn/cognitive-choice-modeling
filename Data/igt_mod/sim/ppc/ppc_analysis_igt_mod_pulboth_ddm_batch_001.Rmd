---
title: "Posterior Predictive Check Analysis: igt_mod - pulboth_ddm - batch_001"
output: 
  html_document:
    toc: true
    toc_float: true
...
# Define input files
subject_file <- "/Users/icd/Library/CloudStorage/Dropbox/Projects/modeling_mIGT/Data/sim/ppc/ppc_subject_summary_task-igt_mod_model-pulboth_ddm_group-batch_001.csv"
model_file <- "/Users/icd/Library/CloudStorage/Dropbox/Projects/modeling_mIGT/Data/sim/ppc/ppc_model_summary_task-igt_mod_model-pulboth_ddm_group-batch_001.csv"
block_file <- "/Users/icd/Library/CloudStorage/Dropbox/Projects/modeling_mIGT/Data/sim/ppc/ppc_block_stats_task-igt_mod_model-pulboth_ddm_group-batch_001.csv"
...
This document presents posterior predictive check (PPC) analysis for the **pulboth_ddm** model (RL_SSM type) applied to the **igt_mod** task with group type **batch_001**.
...
This analysis examines how well the pulboth_ddm model can reproduce key behavioral patterns observed in the igt_mod task. The model's fit quality is evaluated through posterior predictive checks, comparing observed statistics to those generated from model simulations.
