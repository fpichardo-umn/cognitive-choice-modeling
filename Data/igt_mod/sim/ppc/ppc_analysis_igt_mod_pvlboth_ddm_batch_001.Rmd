...
# Define input files
subject_file <- "/users/7/fpichard/Projects/modeling_mIGT/Data/sim/ppc/ppc_subject_summary_task-igt_mod_model-pvlboth_ddm_group-batch_001.csv"
model_file <- "/users/7/fpichard/Projects/modeling_mIGT/Data/sim/ppc/ppc_model_summary_task-igt_mod_model-pvlboth_ddm_group-batch_001.csv"
block_file <- "/users/7/fpichard/Projects/modeling_mIGT/Data/sim/ppc/ppc_block_stats_task-igt_mod_model-pvlboth_ddm_group-batch_001.csv"
...
This document presents posterior predictive check (PPC) analysis for the **pvlboth_ddm** model (RL_SSM type) applied to the **igt_mod** task with group type **batch_001**.
