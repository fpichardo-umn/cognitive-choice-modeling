---
title: "Posterior Predictive Check Analysis: igt_mod - puldecay - batch_001"
output: 
  html_document:
    toc: true
    toc_float: true
...
# Define input files
subject_file <- "/users/7/fpichard/Projects/modeling_mIGT/Data/sim/ppc/ppc_subject_summary_task-igt_mod_model-puldecay_group-batch_001.csv"
model_file <- "/users/7/fpichard/Projects/modeling_mIGT/Data/sim/ppc/ppc_model_summary_task-igt_mod_model-puldecay_group-batch_001.csv"
block_file <- "/users/7/fpichard/Projects/modeling_mIGT/Data/sim/ppc/ppc_block_stats_task-igt_mod_model-puldecay_group-batch_001.csv"
...
This document presents posterior predictive check (PPC) analysis for the **puldecay** model (RL type) applied to the **igt_mod** task with group type **batch_001**.
...
This analysis examines how well the puldecay model can reproduce key behavioral patterns observed in the igt_mod task. The model's fit quality is evaluated through posterior predictive checks, comparing observed statistics to those generated from model simulations.
