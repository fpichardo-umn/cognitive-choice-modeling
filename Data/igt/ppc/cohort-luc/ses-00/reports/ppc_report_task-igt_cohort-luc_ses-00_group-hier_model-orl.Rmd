---
title: "Posterior Predictive Check Analysis: igt - orl - hier"
output: 
  html_document:
    toc: true
    toc_float: true
...
ppc_summary_file <- "/Users/icd/Library/CloudStorage/Dropbox/Projects/modeling_mIGT/Data/igt/ppc/cohort-luc/ses-00/stats/ppc_summary_task-igt_cohort-luc_ses-00_group-hier_model-orl.csv"     # ppc_summary_{task}_{model}_{group}.csv
...
This document presents posterior predictive check (PPC) analysis for the **orl** model (**`r model_type`** type) applied to the **igt** task with group type **hier**.
