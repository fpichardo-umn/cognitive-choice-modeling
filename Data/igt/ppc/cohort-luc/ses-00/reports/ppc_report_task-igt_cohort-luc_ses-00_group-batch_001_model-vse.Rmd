---
title: "Posterior Predictive Check Analysis: igt - vse - batch_001"
output: 
  html_document:
    toc: true
    toc_float: true
...
ppc_summary_file <- "/Users/icd/Library/CloudStorage/Dropbox/Projects/modeling_mIGT/Data/igt/ppc/cohort-luc/ses-00/stats/ppc_summary_task-igt_cohort-luc_ses-00_group-batch_001_model-vse.csv"     # ppc_summary_{task}_{model}_{group}.csv
...
This document presents posterior predictive check (PPC) analysis for the **vse** model (**`r model_type`** type) applied to the **igt** task with group type **batch_001**.
...
This analysis examines how well the vse model can reproduce key behavioral patterns observed in the igt task. The model's fit quality is evaluated through posterior predictive checks, comparing observed statistics to those generated from model simulations.
