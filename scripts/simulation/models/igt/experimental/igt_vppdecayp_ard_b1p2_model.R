...
# Individual VPPdecay-ARD Model (12 Accumulators, 3 per deck, "All-Win-First")
...
igtVPPDECAYPARDB1P2Model <- R6::R6Class("igtVPPDECAYPARDB1P2Model",
                                       inherit = ModelBase,
                                       ...
                                       public = list(
                                         ...
                                         simulate_choices = function(trials, parameters, task_params) {
                                           ...
                                           for (t in 1:n_trials) {
                                             ...
                                             # 4. Decay expected values for all decks (VPPdecay rule)
