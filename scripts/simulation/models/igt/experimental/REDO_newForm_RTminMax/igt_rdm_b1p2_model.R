...
igtRDMB1P2Model <- R6::R6Class("igtRDMB1P2Model",
                                  inherit = ModelBase,
                                  ...
                                  public = list(
                                    ...
                                    get_parameter_info = function() {
                                      return(list(
                                        ...
                                        drift_A = list(range = c(0, Inf)),
                                        drift_B = list(range = c(0, Inf)),
                                        drift_C = list(range = c(0, Inf)),
                                        drift_D = list(range = c(0, Inf))
                                      ))
                                    },
                                    ...
                                    simulate_choices = function(trials, parameters) {
                                      ...
                                      # Drift rates for each deck
                                      drift_rates <- c(parameters$drift_A, parameters$drift_B, 
                                                       parameters$drift_C, parameters$drift_D)
                                      ...
                                      for(t in 1:n_trials) {
                                        ...
                                        if (!is.na(forced_choices[t])) {
                                          ...
                                          choices[t] <- which.min(decision_times)
                                          ...
                                          if(rt_adj <= 0) {
                                            ...
                                            if(chosen_drift <= 0) {
                                              ...
                                              log_lik <- self$calculate_race_likelihood(
                                                rt_adj, current_boundary, drift_rates, chosen_deck
                                              )
