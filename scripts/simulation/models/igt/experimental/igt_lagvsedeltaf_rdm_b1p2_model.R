...
# Individual LagVSEDeltaF RDM Model for the Iowa Gambling Task
# Racing Diffusion Model with hybrid frequency learning
# Combines value learning, frequency tracking, and choice lag
# 4 accumulators (1 per deck) - first to finish wins
# Drift rates derived from combined values

igtLAGVSEDELTAFRDMB1P2Model <- R6::R6Class("igtLAGVSEDELTAFRDMB1P2Model",
                                         inherit = ModelBase,
                                         ...
                                         public = list(
                                           ...
                                           simulate_choices = function(trials, parameters, task_params) {
                                             ...
                                             for (t in 1:n_trials) {
                                               ...
                                               PEfreq <- sign_util - ef[winning_choice]
