...
# Individual PVLdecay-ARD Model (12 Accumulators, 3 per deck, "All-Win-First")
# For a deck to be chosen, ALL 3 of its accumulators must finish before 
# ALL 9 accumulators from the other 3 decks.

igtPVLDECAYLARDB1P2Model <- R6::R6Class("igtPVLDECAYLARDB1P2Model",
                                       inherit = ModelBase,
                                       ...
                                       public = list(
                                         ...
                                         simulate_choices = function(trials, parameters, task_params) {
                                           ...
                                           for (t in 1:n_trials) {
                                             ...
                                             # Update EV using PVL-decay rule
                                         ...
                                         calculate_loglik = function(data, parameters, task_params) {
                                           ...
                                           for (t in 1:n_trials) {
                                             ...
                                             # Update EV for the chosen deck using PVL-decay rule
                                             current_win <- wins[t]
