...
igtVPPDELTAARDB1P2Model <- R6::R6Class("igtVPPDELTAARDB1P2Model",
                                       inherit = ModelBase,
                                       ...
                                       public = list(
                                         ...
                                         simulate_choices = function(trials, parameters, task_params) {
                                           ...
                                           for (t in 1:n_trials) {
                                             ...
                                             # Combined value for each deck: w * ev + (1-w) * pers
                                             ...
                                             for (i in 1:4) {
                                               for (j in 1:3) {
                                                 ...
                                                 # Combined values
                                                 combined_value_i <- parameters$w * ev[i] + (1 - parameters$w) * pers[i]
