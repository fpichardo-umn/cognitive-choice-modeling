igt_modPULDECAYTICModel <- R6::R6Class("igt_modPULDECAYTICModel",
                           inherit = ModelBase,
                             ...
                             simulate_choices = function(trials, parameters) {
                               ...
                               for(t in 1:n_trials) {
                                 ...
                                 if(choices[t] == 1) {
                                   ...
                                   # Calculate PUL utility: pow(abs(outcome), mag) * (outcome > 0 ? gain : -loss)
                                   ...
                                   # Update without learning rate (only direct utility)
