...
igt_modNNLDECAYDDMB1P2Model <- R6::R6Class("igt_modNNLDECAYDDMB1P2Model",
                           inherit = ModelBase,
                           ...
                           public = list(
                             ...
                             simulate_choices = function(trials, parameters) {
                               ...
                               for(t in 1:n_trials) {
                                 ...
                                 # Update EV using decay rule
                                 self$ev <- self$ev * (1 - as.numeric(parameters$decay))  # Decay all values
                                 
                                 # Add utility to chosen deck if played
                                 if(choices[t] == 1) {
                                   # Generate outcome
